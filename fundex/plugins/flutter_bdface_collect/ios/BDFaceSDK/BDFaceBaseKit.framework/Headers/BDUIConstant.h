...
#define face_bundleImage(name) [UIImage imageNamed:name inBundle:[NSBundle bundleWithPath:face_imagePath] compatibleWithTraitCollection:nil]

#define face_imagePath  [[NSBundle mainBundle] pathForResource:@"com.baidu.idl.face.image" ofType:@"bundle"]
